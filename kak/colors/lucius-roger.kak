...
evaluate-commands %sh{
    ...
    echo "
        ...
        face global Information ${lucius_lighter_grey},${lucius_dark_grey}
        face global Error ${lucius_light_red},${lucius_dark_red}
        face global StatusLine ${lucius_lighter_grey},${lucius_darker_grey}
        face global StatusLineMode ${lucius_light_grey},${lucius_darker_gray}+b
        face global StatusLineInfo ${lucius_lighter_grey},${lucius_darker_grey}
